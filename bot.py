...
Name = 'Hide on bush'
region = 'kr'
lol_watcher = LolWatcher(RIOTTOKEN)

response = lol_watcher.summoner.by_name(region, Name)
print("{}의 Summoner 레벨: {}".format(
    response["name"],
        ...
        try:
            if len(message.content.split(" ")) == 1:
                ...
                embed.set_footer(text='Data by Official Riot API : https://developer.riotgames.com/',
                                 icon_url='https://i.imgur.com/ltiu4g8.png')
                await message.channel.send("Summoner name not entered!", embed=embed)
            else:
                ...
                if not getPersonalRecordBox:
                    ...
                    embed.set_footer(text='Data by Official Riot API : https://developer.riotgames.com/',
                                     icon_url='https://i.imgur.com/ltiu4g8.png')
                    await message.channel.send("The summoner for this nickname does not exist.", embed=embed)
                else:
                    ...
                    if len(record) == 2:
                        ...
                        embed.set_thumbnail(
                            url=f"https://github.com/J-hoplin1/League-Of-Legend-Search-Bot/blob/master/Riot%20API%20Version/ranked-emblems/Emblem_{thumbnail}.png?raw=true")
                        embed.set_footer(text='Data by Official Riot API : https://developer.riotgames.com/',
                                         icon_url='https://i.imgur.com/ltiu4g8.png')
                        await message.channel.send("Summoner \"" + playerNickname + "\"\'s recode", embed=embed)
                        ...
                        embed.set_thumbnail(
                            url="https://github.com/J-hoplin1/League-Of-Legend-Search-Bot/blob/master/Riot%20API%20Version/ranked-emblems/Emblem_DEFAULT.png?raw=true")
                        embed.set_footer(text='Data by Official Riot API : https://developer.riotgames.com/',
                                         icon_url='https://i.imgur.com/ltiu4g8.png')
                        await message.channel.send("Summoner \"" + playerNickname + "\"\'s recode", embed=embed)
                        ...
                        embed.add_field(
                            name=f"Most Used Champion : {mastery['championname']}", value=f"Proficiency Level : {mastery['championlevel']}.Lv / Champion Point : {mastery['championpoint']}pt")
                        embed.set_thumbnail(
                            url=f"https://github.com/J-hoplin1/League-Of-Legend-Search-Bot/blob/master/Riot%20API%20Version/ranked-emblems/Emblem_{record['Flex 5:5 Rank']['tier']}.png?raw=true")
                        embed.set_footer(text='Data by Official Riot API : https://developer.riotgames.com/',
                                         icon_url='https://i.imgur.com/ltiu4g8.png')
                        await message.channel.send("Summoner \"" + playerNickname + "\"\'s recode", embed=embed)
                        ...
                        embed.add_field(
                            name=f"Most Used Champion : {mastery['championname']}", value=f"Proficiency Level : {mastery['championlevel']}.Lv / Champion Point : {mastery['championpoint']}pt")
                        embed.set_thumbnail(
                            url=f"https://github.com/J-hoplin1/League-Of-Legend-Search-Bot/blob/master/Riot%20API%20Version/ranked-emblems/Emblem_{record['Personal/Duo Rank']['tier']}.png?raw=true")
                        embed.set_footer(text='Data by Official Riot API : https://developer.riotgames.com/',
                                         icon_url='https://i.imgur.com/ltiu4g8.png')
                        await message.channel.send("Summoner \"" + playerNickname + "\"\'s recode", embed=embed)
        ...
        try:
            if len(message.content.split(" ")) == 1:
                ...
                if not getMasteryBox:
                    ...
                    embed.set_footer(text='Data by Official Riot API : https://developer.riotgames.com/',
                                     icon_url='https://i.imgur.com/ltiu4g8.png')
                    await message.channel.send("It's a summoner who doesn't exist.", embed=embed)
                else:
                    embed = discord.Embed(
                    ...
                    embed.set_footer(text='Data by Official Riot API : https://developer.riotgames.com/',
                                     icon_url='https://i.imgur.com/ltiu4g8.png')
                    await message.channel.send("Summoner \"" + playerNickname + "\"\'s Most Top3", embed=embed)
        except BaseException as e:
